# cf-boardgames Development Guidelines
...
- [01;31m[K**Language/Version**: [m[KTypeScript 5.x, Node.js 20+ + [01;31m[K**Primary Dependencies**: [m[KNext.js 14.2 (App Router), React 18.3, next-intl for i18n, Tailwind CSS 3.4 (001-fix-i18n-translations)
- [01;31m[K**Storage**: [m[KBrowser localStorage for user preferences (indefinite persistence), JSON files for translation dictionaries (001-fix-i18n-translations)
...
## Recent Changes
- 001-fix-i18n-translations: Added [01;31m[K**Language/Version**: [m[KTypeScript 5.x, Node.js 20+ + [01;31m[K**Primary Dependencies**: [m[KNext.js 14.2 (App Router), React 18.3, next-intl for i18n, Tailwind CSS 3.4
